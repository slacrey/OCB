...
var DashboardApps = Widget.extend({
    ...
    confirm_upgrade: function() {
        framework.redirect("https://www.seelyn.com/odoo-enterprise/upgrade?num_users=" + (this.data.enterprise_users || 1));
    },
});
...
var DashboardShare = Widget.extend({
    ...
    share_linkedin: function(){
        var popup_url = _.str.sprintf('http://www.linkedin.com/shareArticle?mini=true&url=%s&title=I am using odoo&summary=%s&source=www.seelyn.com', encodeURIComponent(this.share_url), this.share_text);
        this.sharer(popup_url);
    },
